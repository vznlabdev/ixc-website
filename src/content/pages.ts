export const pageContent = {
  features: {
    ...
    cta: {
      ...
      titleBreak: "No limits. No credit card.",
      description: "Just 30 days to experience the difference",
      buttonText: "Start Free Trial",
      buttonUrl: "/contact",
      smallText: "No credit card required. Setup in minutes."
    },
    cards: [
      {
