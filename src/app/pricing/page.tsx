            ...
            <Card className="shadow-sm">
              ...
              <CardContent>
                <ul className="space-y-3 mb-6">
                  ...
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
                    <span>Basic workflow tools</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
          ...
          <div className="space-y-8">
            {[...Array(4)].map((_, i) => (
              <Card key={i} className="shadow-sm">
                <CardHeader>
                  <CardTitle className="text-lg">Sample Question {i + 1}?</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground">
                    This is a placeholder answer for the frequently asked question. You can replace this with actual content about your pricing plans and features.
                  </p>
                </CardContent>
              </Card>
            ))}
